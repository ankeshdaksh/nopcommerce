...
public class HomePage extends BasePage {
    ...
    @FindBy(xpath = "html/body/div[5]/div[3]/div/div/div/div[2]/div/div[1]/strong")
    WebElement thankssMsg;
    ...
    public void checkOutOrderDetail() {
        ...
        WebDriverWait confirms = new WebDriverWait(driver, 30);
