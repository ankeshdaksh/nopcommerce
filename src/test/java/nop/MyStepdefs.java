...
public class MyStepdefs {
    ...
    @When("^he change the currency \"([^\"]*)\" into another currence$")
    public void heChangeTheCurrencyIntoAnotherCurrence(String arg0) throws Throwable {
       changeCurrency.changeTheCurrency();

    }

    @Then("^he can be seen the changes in product prices$")
    public void heCanBeSeenTheChangesInProductPrices() throws Throwable {
       // changeCurrency.checkingEuroCurrency();
